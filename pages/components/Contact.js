        ...
        <div className="grid gap-8 lg:grid-cols-5">
          ...
          <div className="w-full h-full col-span-3 p-4 shadow-xl lg:col-span-2 rounded-xl">
            <div className="h-full lg:p-4">
              ...
              <div>
                <h2 className="text-teal-700 pt-7">Ram Ghimire</h2>
                <h3 className="text-gray-400">Blockchain/Software Developer</h3>
                <p className="pt-3">
                  I am available for Web3/Blockchain project collaboration
                </p>
              </div>
              <div>
